...
uint32_t _get_mem_long_bank_wrap(memory_t *, uint32_t);
...
uint32_t _addrCPU_getAbsoluteIndexedX(CPU_t *, memory_t *);
uint32_t _addrCPU_getAbsoluteIndexedY(CPU_t *, memory_t *);
uint32_t _addrCPU_getLongIndexedX(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPage(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPageIndirect(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPageIndirectLong(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPageIndexedX(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPageIndexedIndirectX(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPageIndexedY(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPageIndirectIndexedY(CPU_t *, memory_t *);
uint32_t _addrCPU_getDirectPageIndirectLongIndexedY(CPU_t *, memory_t *);
